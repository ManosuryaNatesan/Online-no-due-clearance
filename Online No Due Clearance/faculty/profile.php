...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_FILES['profile_image']) && $_FILES['profile_image']['error'] == 0) {
        ...
        if (in_array(strtolower($filetype), $allowed)) {
            $new_filename = "faculty_" . $faculty_id . "_" . time() . "." . $filetype;
            $upload_path = "../images/" . $new_filename;
            
            if (move_uploaded_file($_FILES['profile_image']['tmp_name'], $upload_path)) {
                // Update profile with new image
                $update_query = "UPDATE faculty SET name = '$name', email = '$email', mobile = '$mobile', profile_image = '$new_filename' WHERE faculty_id = $faculty_id";
            }
        }
    } else {
        // Update profile without changing image
        $update_query = "UPDATE faculty SET name = '$name', email = '$email', mobile = '$mobile' WHERE faculty_id = $faculty_id";
    }
...
<head>
    ...
    <title>Faculty Profile - College Management System</title>
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            <img src="../images/<?php echo $faculty['profile_image']; ?>" alt="Profile Image" class="profile-image mb-3">
                        ...
                        <div class="card-body">
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="mobile" name="mobile" class="form-control" value="<?php echo $faculty['mobile']; ?>" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="department" class="form-control" value="<?php echo $faculty['department']; ?>" readonly>
                                    <small class="text-muted">Department cannot be changed</small>
                                </div>
                                
                                <div class="form-group">
                                    <label for="designation">Designation</label>
                                    <input type="text" id="designation" class="form-control" value="<?php echo $faculty['designation']; ?>" readonly>
                                    <small class="text-muted">Designation cannot be changed</small>
                                </div>
